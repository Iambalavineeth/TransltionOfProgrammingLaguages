...
%{
	...
	extern int try_except_complexity;
	extern bool try_block;
	extern bool finally_parse;
%}
...
funcdef // Used in: decorated, compound_stmt
	: DEF NAME parameters COLON suite 
	{
	 if(@1.first_column-1 == 0){
		std::cout<<"(\""<<@1.first_line<<":"<<@1.first_column -1 <<": \'"<< yylval.id<<"\'\", "<<complexity<<")"<<std::endl;	 	
		delete[] yylval.id;		
		yylval.id = '\0';
	 	complexity = 1;
		try_except_complexity=0;
		try_block = false;	 
		finally_parse = false;
	 }else{
		++complexity;
...
while_stmt // Used in: compound_stmt
	: WHILE test COLON suite ELSE COLON suite {++complexity;}
	| WHILE test COLON suite {++complexity;}
	;
for_stmt // Used in: compound_stmt
	: FOR exprlist IN testlist COLON suite ELSE COLON suite {++complexity;}
	| FOR exprlist IN testlist COLON suite {++complexity;}
	;
try_stmt // Used in: compound_stmt
	: TRY COLON suite plus_except opt_ELSE opt_FINALLY {				
		if(try_block && finally_parse){
			complexity = try_except_complexity;					
		}	
	 }
	| TRY COLON suite FINALLY COLON suite {
		finally_parse = true; complexity = try_except_complexity;	
	 }
	;
...
except_clause // Used in: plus_except
	...
	| EXCEPT {if(!finally_parse){++complexity;}}
	;
